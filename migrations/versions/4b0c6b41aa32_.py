...
Revision ID: 4b0c6b41aa32
Revises: 
Create Date: 2018-04-19 09:05:26.900820
...
def upgrade():
    ...
    sa.Column('return_status', sa.Boolean(create_constraint=False), nullable=True),
    sa.ForeignKeyConstraint(['book_id'], ['books.book_id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ),
    sa.PrimaryKeyConstraint('borrow_id'),
    sa.UniqueConstraint('borrow_id')
    )

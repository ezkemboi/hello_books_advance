            ...
            if authors is not None:
                if publisher is not None:
                    if year is not None:
                        ...
                        return jsonify({'message': "Fill in ISNB"})
                    return jsonify({'message': "Fill in the year published"})
                return jsonify({'message': "Fill in the publisher"})
            return jsonify({'message': "Fill in the authors"})
        return jsonify({'message': "Fill the book title"})
